...
const (
	...
	ErrorLevel
	// DPanicLevel logs are particularly important errors. In development the log panics after writing the message.
	DPanicLevel
...
// Tags adds default tags for log
...
// NewWithOutput creates log depending on mode
...
// NewEnv creates log depending on mode
